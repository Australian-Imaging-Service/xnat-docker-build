...
ARG ohif_viewer_ver=3.8.0-fat
ARG openid_auth_ver=1.5.0-xpl
ARG xsync_ver=1.8.1
...
RUN <<EOT
  ...
  curl -sSL -o /tmp/xnat-web-${XNAT_VERSION}.war \
    ...
    "https://filesender.aarnet.edu.au/download.php?token=85cdb105-1483-4c80-934f-a6cd8cfc4227&files_ids=28680520"
